...
?>
    ...
    <head>
        ...
        <title>Quản Trị - Quân Mobile</title>
        ...
        <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                 ...
                 <li><a href="quantri.php?page_layout=donhang"><svg class="glyph stroked gear">
            ...
            if (isset($_GET['page_layout'])) {
                switch ($_GET['page_layout']) {
                    ...
                    case 'thongtin':
                        ...
                        break;
                    case 'donhang':
                        include_once './chucnang/donhang/danhsachdonhang.php';
                        break;
                    case 'suadh':
                        include './chucnang/donhang/suadh.php';
                        break;    
                   /*  case 'donhang2':
